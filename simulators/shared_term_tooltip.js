...
(function() {
  const GLOSSARY = {
    ...
    // ==========================================
    '人工肺': {
      title: '人工肺（体外式膜型人工肺 / Oxygenator）',
      desc: '肺の代わりに血液中へ酸素を取り込み、二酸化炭素を排出する医療機器です。数千本の中空糸膜の外側を血液が流れ、内側を酸素ガスが通過してガス交換を行います。'
    },
    'ECMO': {
      title: 'ECMO（体外式膜型人工肺 / エクモ）',
      desc: '重症の心不全や呼吸不全の患者さんに対して、体外のポンプと人工肺で血液循環とガス交換を代行し、心臓や肺を休ませて回復を待つ救命システムです。'
    },
    '体外循環': {
      title: '体外循環（Extracorporeal Circulation）',
      desc: '心臓の手術中などに、血液を体外の回路（チューブ、ポンプ、人工肺、熱交換器）へと誘導して酸素化や温度調整を行い、再び体内へ送り返す技術です。'
    },
    'ガス交換': {
      title: 'ガス交換（分圧差による拡散現象）',
      desc: '酸素と二酸化炭素が、濃度の濃い方（分圧の高い方）から薄い方へと中空糸膜の微小な隙間を通り抜けて移動する物理現象です。'
    },
    '熱交換器': {
      title: '熱交換器（人工肺内蔵型温度調整器）',
      desc: '血液と温度制御された水が混ざることなく金属管を介して熱をやり取りし、手術中の患者さんの体温を正確に下げたり戻したりする装置です。'
    },
    'ヘモグロビン解離曲線': {
      title: '酸素ヘモグロビン解離曲線（Hillの式）',
      desc: '血液中の酸素分圧とヘモグロビンが酸素をどれだけ抱え込めるか（酸素飽和度）の関係を表すS字カーブです。肺で効率よく酸素を受け取り、組織で手放す絶妙な仕組みを持っています。'
    },
  };
